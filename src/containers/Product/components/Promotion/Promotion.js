  ...
  render() {
    return (
        <React.Fragment>
            ...
            <Container fluid className="products-conversions px-0">
                <div className="product-dots-teal" />
                <div className="product-dots-purple" />
                <Row className="conversions-1 m-0">
                    <Col className="m-auto product-conversions px-0">
                ...
                <Container className="conversions-2">
                    <Row>
